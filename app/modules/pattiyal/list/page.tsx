...
import PendingPattiyalTable from "./components/PendingPattiyalTable";
import CompletedPattiyalTable from "./components/CompletedPattiyalTable";
import TradersTable from "./components/TradersTable";
import FarmersTable from "./components/FarmersTable";

// Define tab key types
type TabKey = "pending" | "completed" | "traders" | "farmers";

const tabs: TabKey[] = ["pending", "completed", "traders", "farmers"];
...
const PattiyalList = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "pending":
        return <PendingPattiyalTable onSidebarToggle={() => {}} />;
      case "completed":
        return <CompletedPattiyalTable onSidebarToggle={() => {}} />;
      case "traders":
        return <TradersTable onSidebarToggle={() => {}} />;
      case "farmers":
        return <FarmersTable onSidebarToggle={() => {}} />;
      default:
        return <PendingPattiyalTable onSidebarToggle={() => {}} />;
    }
  };
                ...
                <li key={tab}>
                  ...
                  >
                    <span className="flex items-center gap-1">
                      ...
                      {tab === "traders" && <i className="ri-store-2-line mr-1"></i>}
                      {tab === "farmers" && <i className="ri-plant-line mr-1"></i>}
