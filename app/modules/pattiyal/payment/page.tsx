...
const PaymentPattiyal: React.FC = () => {
  return (
    <Layout pageTitle="Pattiyal Payment">
      {/* This is the key wrapper: it will fill the available height from Layout */}
      <div className="flex flex-col h-full min-h-screen"> {/* Added min-h-screen for fallback */}
        ...
        <footer className="bg-[#EBEFF3] px-4 py-2 h-[50px] flex-shrink-0 mb-[45px]" id="pattiyal_footer">
