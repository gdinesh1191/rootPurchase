...
import AllWaymentList from "./components/AllWaymentList";
import PendingWaymentList from "./components/PendingWaymentList";


// Define tab key types
type TabKey = "all" |"pending" ;

const tabs: TabKey[] = ["all", "pending",];
...
const WaymentList = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "all":
        return <AllWaymentList onSidebarToggle={() => {}} />;
      case "pending":
        return <PendingWaymentList onSidebarToggle={() => {}} />;
  ...
  return (
    <Layout pageTitle="Wayment Management">
